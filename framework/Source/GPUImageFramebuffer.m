...
- (void)unlock;
{
    ...
    if (framebufferReferenceCount <= 0) NSLog(@"Tried to overrelease a framebuffer, did you forget to call -useNextFrameForImageCapture before using -imageFromCurrentFramebuffer?");
